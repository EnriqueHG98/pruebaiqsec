      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <form action="{{ route('desactivarBeneficios', ['id' => $contratado->idBeneficio]) }}" method="POST">
                @csrf
                @method('delete')
              <button class="btn btn-primary btn-primary-outline-success" type="submit">Eliminar</button>
              </form>
            </td> 
          </tr>
          @endforeach
